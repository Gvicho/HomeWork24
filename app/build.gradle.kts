...
android {
    namespace = "com.example.homework24"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.homework24"
        minSdk = 28
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    testImplementation("org.jetbrains.kotlinx:kotlinx-coroutines-test:1.7.1")// for test coroutines
